...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onChange(of: cleanRoute) { _, newRoute in
            UIAccessibility.post(notification: .screenChanged, argument: nil)
            // Voice listening stays available on every screen (home manages its own in onAppear).
    ...
    private func showCleanArrival() {
        ...
        // The arrival screen speaks the arrival summary and confidence question on appear.
        withAnimation {
            cleanRoute = .arrival
        }
    }
