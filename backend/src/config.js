...
export function loadConfig(env = process.env) {
  ...
  return {
    ...
    googleTtsApiKey: env.GOOGLE_TTS_API_KEY || env.GOOGLE_MAPS_API_KEY || "",
    googleTtsVoice: env.GOOGLE_TTS_VOICE || "en-US-Wavenet-F",
    googleTtsAudioEncoding: env.GOOGLE_TTS_AUDIO_ENCODING || "MP3",
